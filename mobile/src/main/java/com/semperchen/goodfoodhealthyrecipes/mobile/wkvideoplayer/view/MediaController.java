package com.semperchen.goodfoodhealthyrecipes.mobile.wkvideoplayer.view;
...
//            mMediaControl.onPageTurn();
    ...
    public void setPlayState(PlayState playState) {
        mPlayImg.setImageResource(playState.equals(PlayState.PLAY) ? R.mipmap.biz_video_pause : R.mipmap.biz_video_play);
    }
